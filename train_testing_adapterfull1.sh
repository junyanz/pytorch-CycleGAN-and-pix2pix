python train.py --dataroot /n/pfister_lab2/Lab/scajas/DATASETS/DATASET_pix2pix/train/ --name exp4_case2_testing --dataset_mode adapterfull1 --model pix2pix --direction BtoA  --use_wandb --n_epochs 250 
