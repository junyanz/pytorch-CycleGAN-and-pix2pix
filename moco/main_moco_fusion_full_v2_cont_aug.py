...
from copd_dataset_full_v3 import COPD_dataset as COPD_dataset_patch
from copd_dataset_full_v3 import default_transform
...
parser.add_argument('--model_A_ckpt', default='/ocean/projects/asc170022p/rohit33/cyclegan_models/checkpoints/copd_emphysema/latest_net_G_A.pth', type=str)
parser.add_argument('--model_B_ckpt', default='/ocean/projects/asc170022p/rohit33/cyclegan_models/checkpoints/copd_emphysema/latest_net_G_B.pth', type=str)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # create model
    model_patch = moco.builder_v3_aug.MoCo(
